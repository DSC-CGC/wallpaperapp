...
public class FactsFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mRef = FirebaseDatabase.getInstance().getReference().child("Facts");
    ...
    public void onStart() {
        ...
        FirebaseRecyclerOptions<Model> options = new FirebaseRecyclerOptions.Builder<Model>()
                ...
                .build();
        FirebaseRecyclerAdapter<Model, FactsFragment.DataViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Model, FactsFragment.DataViewHolder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull final FactsFragment.DataViewHolder holder, final int i, @NonNull Model model) {
            ...
            @NonNull
            @Override
            public FactsFragment.DataViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
                View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.cardview, viewGroup, false);
                return new FactsFragment.DataViewHolder(view);
            }
        };
