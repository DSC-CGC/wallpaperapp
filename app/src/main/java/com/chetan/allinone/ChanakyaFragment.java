...
public class ChanakyaFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mRef = FirebaseDatabase.getInstance().getReference().child("chanakya");
        MobileAds.initialize(getActivity(), "ca-app-pub-9900300904571890~9397633208");
    ...
    public void onStart() {
        ...
        FirebaseRecyclerOptions<Model> options = new FirebaseRecyclerOptions.Builder<Model>()
                ...
                .build();
        FirebaseRecyclerAdapter<Model, ChanakyaFragment.DataViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Model, ChanakyaFragment.DataViewHolder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull final ChanakyaFragment.DataViewHolder holder, final int i, @NonNull Model model) {
            ...
            @NonNull
            @Override
            public ChanakyaFragment.DataViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
                View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.cardview, viewGroup, false);
                return new ChanakyaFragment.DataViewHolder(view);
            }
        };
