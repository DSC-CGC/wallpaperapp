 ...
 */
public class QuotesFrgament extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_quotes_frgament, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mRef = FirebaseDatabase.getInstance().getReference().child("Motivation");
    ...
    public void onStart() {
        ...
        FirebaseRecyclerOptions<Model> options = new FirebaseRecyclerOptions.Builder<Model>()
                ...
                .build();
        FirebaseRecyclerAdapter<Model, QuotesFrgament.DataViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Model, QuotesFrgament.DataViewHolder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull final QuotesFrgament.DataViewHolder holder, final int i, @NonNull Model model) {
            ...
            @NonNull
            @Override
            public QuotesFrgament.DataViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
                View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.cardview, viewGroup, false);
                return new QuotesFrgament.DataViewHolder(view);
            }
        };
