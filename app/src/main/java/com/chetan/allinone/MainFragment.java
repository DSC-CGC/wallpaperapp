...
public class MainFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mRef = FirebaseDatabase.getInstance().getReference().child("Random");
    ...
    public void onStart() {
        ...
        FirebaseRecyclerOptions<Model> options = new FirebaseRecyclerOptions.Builder<Model>()
                ...
                .build();
        final FirebaseRecyclerAdapter<Model, DataViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Model, DataViewHolder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull final DataViewHolder holder, final int i, @NonNull final Model model) {


                final String imgUrl = model.getImage();
                Picasso.get().load(imgUrl).networkPolicy(NetworkPolicy.OFFLINE).into(holder.imageView);
