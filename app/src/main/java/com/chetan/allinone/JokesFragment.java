...
public class JokesFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mRef = FirebaseDatabase.getInstance().getReference().child("Jokes");
    ...
    public void onStart() {
        ...
        FirebaseRecyclerOptions<Model> options = new FirebaseRecyclerOptions.Builder<Model>()
                ...
                .build();
        FirebaseRecyclerAdapter<Model, JokesFragment.DataViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Model, JokesFragment.DataViewHolder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull final JokesFragment.DataViewHolder holder, final int i, @NonNull Model model) {
            ...
            @NonNull
            @Override
            public JokesFragment.DataViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
                View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.cardview, viewGroup, false);
                return new JokesFragment.DataViewHolder(view);
            }
        };
