...
public class WallpaperFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mRef = FirebaseDatabase.getInstance().getReference().child("Wallpaper");
    ...
    public void onStart() {
        ...
        FirebaseRecyclerOptions<Model> options = new FirebaseRecyclerOptions.Builder<Model>()
                ...
                .build();
        FirebaseRecyclerAdapter<Model, WallpaperFragment.DataViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Model, WallpaperFragment.DataViewHolder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull final WallpaperFragment.DataViewHolder holder, final int i, @NonNull Model model) {
            ...
            @NonNull
            @Override
            public WallpaperFragment.DataViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
                View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.cardview, viewGroup, false);
                return new WallpaperFragment.DataViewHolder(view);
            }
        };
